-- ============================================
-- TABLA MEJORADA: planes_suscripcion
-- Incluye tipos: básica, professional, enterprise, custom
-- ============================================
...
-- ============================================
-- TABLA MEJORADA: suscripciones
-- Incluye mejoras basadas en el ejemplo proporcionado
-- ============================================
...
('Plan Básico', 'basica', 'Ideal para cooperativas pequeñas que están comenzando', 29.99, 299.99, 'USD', 5, 3, 50, 10, FALSE, FALSE, FALSE, TRUE),
('Plan Profesional', 'professional', 'Para cooperativas en crecimiento con necesidades avanzadas', 79.99, 799.99, 'USD', 25, 10, 200, 50, TRUE, TRUE, FALSE, TRUE),
('Plan Enterprise', 'enterprise', 'Solución completa para cooperativas grandes', 199.99, 1999.99, 'USD', 100, 50, 1000, 200, TRUE, TRUE, TRUE, TRUE),
